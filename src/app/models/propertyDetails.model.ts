...
const propertyDetailsSchema = new mongoose.Schema<propertyDetails>({
    ...
    propertyFloorPlanFile : {type : String, required : [true, "The floor plan of the property is required!"]},
    ...
    propertyHas : {
        ...
        features: {type : [String], required : [true, "Telling about the features are required!"]}
    },
