...
const propertyDetailsSchema = new mongoose.Schema<propertyDetails>({
    ...
    propertyOwner: {
        ...
        ownerImageURL: { type: String, required: [true, "Owner's image URL is required!"] },
    },
    ...
    comparativeAddress: {
        comparativeAddress1: { type: String, required: [true, "comparativeAddress1 is a required field!"] },
        comparativeAddress2: { type: String, required: [true, "comparativeAddress2 is a required field!"] },
        comparativeAddress3: { type: String, required: [true, "comparativeAddress3 is a required field!"] },
        comparativeAddress4: { type: String, required: [true, "comparativeAddress4 is a required field!"] },
    },
