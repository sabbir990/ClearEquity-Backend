    ...
    comparativeAddress: {
        comparativeAddress1: {
            type: {
                address: String,
                price: Number,
                status: {type: String, lowercase: true, default: "sale"},
                beds: Number,
                baths: Number,
                size: Number,
                websiteURL: String,
            }, required: [true, "comparativeAddress1 is a required field!"]
        },
        comparativeAddress2: { type: {
                address: String,
                price: Number,
                status: {type: String, lowercase: true, default: "sale"},
                beds: Number,
                ...
                size: Number,
                websiteURL: String,
            }, required: [true, "comparativeAddress2 is a required field!"] },
        comparativeAddress3: { type: {
                address: String,
                price: Number,
                status: {type: String, lowercase: true, default: "sale"},
                beds: Number,
